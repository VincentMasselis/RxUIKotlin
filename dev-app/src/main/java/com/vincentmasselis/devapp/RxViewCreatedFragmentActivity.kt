...
import com.vincentmasselis.rxuikotlin.fragmentmanager.rxViewCreatedFragments
import com.vincentmasselis.rxuikotlin.utils.ActivityState
import io.reactivex.rxjava3.core.Notification
import io.reactivex.rxjava3.subjects.ReplaySubject

@SuppressLint("CheckResult")
class RxViewCreatedFragmentActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun intent(context: Context, stateToSubscribe: ActivityState, stateToPutFragment: ActivityState) = Intent(context, RxViewCreatedFragmentActivity::class.java)
    ...
    val events = ReplaySubject.create<Notification<List<Fragment>>>()
